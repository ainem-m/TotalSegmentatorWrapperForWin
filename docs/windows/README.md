...
It preserves the architecture and spike decisions that led to this standalone
Windows source repository. Source publication does not promote any unverified
item to a Windows product pass.
