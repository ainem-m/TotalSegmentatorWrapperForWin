...
> **Windows repository note:** この文書とスクリーンショットは、Windows WPF
> 実装が比較対象としたmacOS UI referenceです。Windows完成版の利用手順では
> ありません。Windowsの公開状態は
> [`docs/RELEASE_STATUS.md`](RELEASE_STATUS.md)を確認してください。
...
バグは`https://github.com/ainem-m/TotalSegmentatorWrapperForWin/issues`へ報告して
